...
interface AppStrings {
    ...
    val forwardingTracking: String
    val forwardingEmptyTitle: String
    val forwardingEmptySubtitle: String
    val addForwardingParcel: String
    val forwardingItemNameHint: String
    val overseasTrackingNumberHint: String
    val forwardingAddFailed: String
    val overseasSection: String
    val domesticSection: String
    val addDomesticTrackingNumber: String
    val domesticTrackingNumberHint: String
    val saveDomesticTracking: String
    val domesticNotYetAvailable: String
...
object EnStrings : AppStrings {
    ...
    override val forwardingTracking = "Forwarding tracking"
    override val forwardingEmptyTitle = "No forwarded parcels yet"
    override val forwardingEmptySubtitle = "Register an overseas tracking number to get started"
    override val addForwardingParcel = "Add forwarded parcel"
    override val forwardingItemNameHint = "Item name"
    override val overseasTrackingNumberHint = "Overseas tracking number"
    override val forwardingAddFailed = "Couldn't look this up. Check the tracking number and try again."
    override val overseasSection = "Overseas leg"
    override val domesticSection = "Domestic leg"
    override val addDomesticTrackingNumber = "Add domestic tracking number"
    override val domesticTrackingNumberHint = "Domestic tracking number"
    override val saveDomesticTracking = "Register"
    override val domesticNotYetAvailable = "No domestic tracking number yet"
...
object KoStrings : AppStrings {
    ...
    override val forwardingTracking = "배대지 추적"
    override val forwardingEmptyTitle = "등록된 배대지 소포가 없어요"
    override val forwardingEmptySubtitle = "해외 운송장번호를 등록하면 여기서 확인할 수 있어요"
    override val addForwardingParcel = "배대지 소포 추가"
    override val forwardingItemNameHint = "상품명"
    override val overseasTrackingNumberHint = "해외 운송장번호"
    override val forwardingAddFailed = "조회에 실패했어요. 운송장번호를 확인하고 다시 시도해 주세요."
    override val overseasSection = "해외 구간"
    override val domesticSection = "국내 구간"
    override val addDomesticTrackingNumber = "국내 운송장 추가"
    override val domesticTrackingNumberHint = "국내 운송장번호"
    override val saveDomesticTracking = "등록"
    override val domesticNotYetAvailable = "아직 국내 운송장이 등록되지 않았어요"
...
object ZhStrings : AppStrings {
    ...
    override val forwardingTracking = "转运追踪"
    override val forwardingEmptyTitle = "还没有转运包裹"
    override val forwardingEmptySubtitle = "登记海外运单号即可开始追踪"
    override val addForwardingParcel = "添加转运包裹"
    override val forwardingItemNameHint = "商品名称"
    override val overseasTrackingNumberHint = "海外运单号"
    override val forwardingAddFailed = "查询失败，请检查运单号后重试。"
    override val overseasSection = "海外段"
    override val domesticSection = "国内段"
    override val addDomesticTrackingNumber = "添加国内运单号"
    override val domesticTrackingNumberHint = "国内运单号"
    override val saveDomesticTracking = "登记"
    override val domesticNotYetAvailable = "尚未登记国内运单号"
...
object ViStrings : AppStrings {
    ...
    override val forwardingTracking = "Theo dõi vận chuyển hộ"
    override val forwardingEmptyTitle = "Chưa có bưu kiện vận chuyển hộ nào"
    override val forwardingEmptySubtitle = "Đăng ký mã vận đơn quốc tế để bắt đầu"
    override val addForwardingParcel = "Thêm bưu kiện vận chuyển hộ"
    override val forwardingItemNameHint = "Tên sản phẩm"
    override val overseasTrackingNumberHint = "Mã vận đơn quốc tế"
    override val forwardingAddFailed = "Không tra cứu được. Kiểm tra mã vận đơn và thử lại."
    override val overseasSection = "Chặng quốc tế"
    override val domesticSection = "Chặng nội địa"
    override val addDomesticTrackingNumber = "Thêm mã vận đơn nội địa"
    override val domesticTrackingNumberHint = "Mã vận đơn nội địa"
    override val saveDomesticTracking = "Đăng ký"
    override val domesticNotYetAvailable = "Chưa có mã vận đơn nội địa"
...
object ThStrings : AppStrings {
    ...
    override val forwardingTracking = "ติดตามพัสดุนำเข้า"
    override val forwardingEmptyTitle = "ยังไม่มีพัสดุนำเข้า"
    override val forwardingEmptySubtitle = "ลงทะเบียนเลขพัสดุต่างประเทศเพื่อเริ่มติดตาม"
    override val addForwardingParcel = "เพิ่มพัสดุนำเข้า"
    override val forwardingItemNameHint = "ชื่อสินค้า"
    override val overseasTrackingNumberHint = "เลขพัสดุต่างประเทศ"
    override val forwardingAddFailed = "ค้นหาไม่สำเร็จ กรุณาตรวจสอบเลขพัสดุแล้วลองใหม่"
    override val overseasSection = "ช่วงต่างประเทศ"
    override val domesticSection = "ช่วงในประเทศ"
    override val addDomesticTrackingNumber = "เพิ่มเลขพัสดุในประเทศ"
    override val domesticTrackingNumberHint = "เลขพัสดุในประเทศ"
    override val saveDomesticTracking = "ลงทะเบียน"
    override val domesticNotYetAvailable = "ยังไม่มีเลขพัสดุในประเทศ"
...
object RuStrings : AppStrings {
    ...
    override val forwardingTracking = "Отслеживание пересылки"
    override val forwardingEmptyTitle = "Пока нет пересылаемых посылок"
    override val forwardingEmptySubtitle = "Зарегистрируйте зарубежный трек-номер, чтобы начать"
    override val addForwardingParcel = "Добавить пересылаемую посылку"
    override val forwardingItemNameHint = "Название товара"
    override val overseasTrackingNumberHint = "Зарубежный трек-номер"
    override val forwardingAddFailed = "Не удалось найти. Проверьте трек-номер и попробуйте снова."
    override val overseasSection = "Зарубежный участок"
    override val domesticSection = "Участок по Корее"
    override val addDomesticTrackingNumber = "Добавить местный трек-номер"
    override val domesticTrackingNumberHint = "Местный трек-номер"
    override val saveDomesticTracking = "Зарегистрировать"
    override val domesticNotYetAvailable = "Местный трек-номер ещё не указан"
...
object JaStrings : AppStrings {
    ...
    override val forwardingTracking = "転送追跡"
    override val forwardingEmptyTitle = "転送中の荷物はまだありません"
    override val forwardingEmptySubtitle = "海外追跡番号を登録すると始まります"
    override val addForwardingParcel = "転送荷物を追加"
    override val forwardingItemNameHint = "商品名"
    override val overseasTrackingNumberHint = "海外追跡番号"
    override val forwardingAddFailed = "照会に失敗しました。追跡番号を確認してもう一度お試しください。"
    override val overseasSection = "海外区間"
    override val domesticSection = "国内区間"
    override val addDomesticTrackingNumber = "国内追跡番号を追加"
    override val domesticTrackingNumberHint = "国内追跡番号"
    override val saveDomesticTracking = "登録"
    override val domesticNotYetAvailable = "まだ国内追跡番号が登録されていません"
